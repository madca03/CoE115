...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/blinky2.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    ../../../../../Program\ Files\ (x86)/Microchip/xc16/v1.30/support/PIC24F/gld/p24FJ64GB202.gld
...
dist/${CND_CONF}/${IMAGE_TYPE}/blinky2.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   ../../../../../Program\ Files\ (x86)/Microchip/xc16/v1.30/support/PIC24F/gld/p24FJ64GB202.gld
	...
	${MP_CC_DIR}\\xc16-bin2hex dist/${CND_CONF}/${IMAGE_TYPE}/blinky2.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} -a  -omf=elf  
